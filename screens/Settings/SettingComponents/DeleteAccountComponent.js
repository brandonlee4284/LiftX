        ...
        <View>
            <View style={styles.container}>
                <TouchableOpacity style={styles.row} onPress={handleDelete}>
                    <MaterialCommunityIcons name="account-remove" size={getResponsiveFontSize(24)} style={styles.icon} />
                        ...
                        <TouchableWithoutFeedback>
                            <View style={styles.modalContainer}>
                                ...
                                <View style={styles.buttonContainer}>
                                    ...
                                    <TouchableOpacity style={styles.resumeButton} onPress={confirmDelete}>
